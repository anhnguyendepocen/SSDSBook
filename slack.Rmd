...
```{r echo=FALSE, fig.align="center", out.width = '95%'}
knitr::include_graphics("images/slackMessageOpts.png")
```
...
```{r echo=FALSE, fig.align="center", out.width = '95%'}
knitr::include_graphics("images/slackMessageReact.png")
```
...
knitr::include_graphics("images/slackMessageThread.png")
```
...
knitr::include_graphics("images/slackMessageShare.png")
```
...
```{r echo=FALSE, fig.align="center", out.width = '95%'}
knitr::include_graphics("images/slackMessageShared.png")
```
...
```{r echo=FALSE, fig.align="center", out.width = '95%'}
knitr::include_graphics("images/slackToolbar.png")
```
...
```{r echo=FALSE, fig.align="center", out.width = '95%'}
knitr::include_graphics("images/slackUpload.png")
```
...
```{r echo=FALSE, fig.align="center", out.width = '95%'}
knitr::include_graphics("images/slackSnippetEdit.png")
```
