...
knitr::include_graphics("images/courseWorkflow.png")
```
...
knitr::include_graphics("images/ggplot2Readme.png")
```
...
```{r echo=FALSE, fig.align="center", out.width = '95%'}
knitr::include_graphics("images/readmeBadges.png")
```
...
```{r echo=FALSE, fig.align="center", out.width = '95%'}
knitr::include_graphics("images/readmeBadgesEx.png")
```
...
```{r echo=FALSE, fig.align="center", out.width = '95%'}
knitr::include_graphics("images/webpageBadgesEx.png")
```
...
```{r echo=FALSE, fig.align="center", out.width = '95%'}
knitr::include_graphics("images/release.png")
```
...
```{r echo=FALSE, fig.align="center", out.width = '95%'}
knitr::include_graphics("images/releaseEx.png")
```
...
```{r echo=FALSE, fig.align="center", out.width = '95%'}
knitr::include_graphics("images/slackNews.png")
```
